...
class AutoMlJobProvider(BaseDynamicProvider):
    """
    The provider for a AutoMlJob resource.
    ...
    def create(self, inputs):
        ...
        pulumi.info(
            f"Creating AutoMlJob resource (param1={inputs.get('param1')},param2={inputs.get('param2')})..."
        )
        pulumi.info(
    ...
    def update(self, id, _olds, props):
        ...
        pulumi.info(
            f"Updating AutoMlJob[{id}] to (param1={props.get('param1')},param2={props.get('param2')})..."
        )
        pulumi.info(
            f"Using provider parameters ({self.provider_params.provider_param1},{self.provider_params.provider_param2})"
        )
    ...
    def delete(self, id, props):
        pulumi.info(f"Deleting AutoMlJob[{id}]")
        pulumi.info(
            f"Using provider parameters ({self.provider_params.provider_param1},{self.provider_params.provider_param2})"
        )
